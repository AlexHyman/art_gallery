{
  ...
  output: {
    path: 'S:\\project\\art_gallery\\dist',
    filename: '[name].js',
    publicPath: '/',
    globalObject: 'this'
  },
      ...
      /* config.module.rule('vue') */
      {
        ...
        use: [
          /* config.module.rule('vue').use('cache-loader') */
          {
            loader: 'cache-loader',
            options: {
              cacheDirectory: 'S:\\project\\art_gallery\\node_modules\\.cache\\vue-loader',
              cacheIdentifier: '69cede25'
            }
          },
        ...
        use: [
          /* config.module.rule('eslint').use('eslint-loader') */
          {
            ...
            options: {
              ...
              cache: true,
              cacheIdentifier: '7c3e152c',
              emitWarning: true,
              emitError: false,
              eslintPath: 'S:\\project\\art_gallery\\node_modules\\eslint\\lib\\api.js',
  ...
  plugins: [
    ...
    new HtmlWebpackPlugin(
      {
        ...
        template: 'S:\\project\\art_gallery\\public\\index.html'
      }
    ),
    ...
    new CopyWebpackPlugin(
      [
        {
          from: 'S:\\project\\art_gallery\\public',
          to: 'S:\\project\\art_gallery\\dist',
          toType: 'dir',
          ignore: [
            'index.html',
            '.DS_Store'
